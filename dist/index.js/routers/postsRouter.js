...
exports.postRouter.post('/', titlePostValidation, shortDescriptionPostValidation, contentPostValidation, bloggerIdPostValidation, titleMidleware_1.postsPostMiddleware, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.postRouter.get('/:id', postGetIdPostValidation, getPostMiddleware_1.getPostMiddleware, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.postRouter.put('/:id', titlePostValidation, shortDescriptionPostValidation, contentPostValidation, bloggerIdPostValidation, postGetIdPostValidation, titleMidleware_1.postsPostMiddleware, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.postRouter.delete('/:id', bloggerIdDeleteValidation, getPostMiddleware_1.getPostMiddleware, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
